    ...
    respostaCerta.classList.add('certaativo')
   ...
   /* document.getElementById('errado1').style.backgroundColor = '#ff2f2f'
    ...
    respostaErrada1.classList.remove('errado')
    respostaErrada2.classList.remove('errado')
    respostaErrada3.classList.remove('errado')
...
function perdeu3(){
    ...
    document.getElementById('certo').addEventListener('click', function clickcerto(){

        const todaserr = document.querySelectorAll('#errado1, #errado2, #errado3')

        todaserr.forEach(todaserrada => {

            todaserrada.classList.add('RESsemhove')
   ...
   // respostaCerta.removeEventListener("click", aumentarponto1);
